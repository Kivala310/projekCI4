                    ...
                    <form method="post" action="/tambah">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="name" id="judul" class="form-control" step="0.1" required name="judul">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="penulis" class="form-label">Penulis</label>
                                <input type="name" id="penulis" class="form-control" step="0.1" required name="penulis">
                            </div>
                            <div class="col-md-6">
                                <label for="penerbit" class="form-label">Penerbit</label>
                                <input type="name" id="penerbit" class="form-control" step="0.1" required name="penerbit">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="tahun terbit" class="form-label">Tahun Terbit</label>
                                <input type="number" id="tahun terbit" class="form-control" step="0.1" required name="tahun_terbit">
                            </div>
                        </div>
